package SudokuPuzzleMaster.computationlogic;
...
import static SudokuPuzzleMaster.problemdomain.SudokuGame.GRID_BOUNDARY;
...
public class GameGenerator {
    ...
    private static int[][] unsolveGame(int[][] solvedGame) {
        ...
        while (solvable == false){
            ...
            //remove 64 random numbers, most difficult puzzle possible!
            if (difficulty.equalsIgnoreCase("master")) {
                while (index < 65) {
                    int xCoordinate = random.nextInt(GRID_BOUNDARY);
                    int yCoordinate = random.nextInt(GRID_BOUNDARY);
