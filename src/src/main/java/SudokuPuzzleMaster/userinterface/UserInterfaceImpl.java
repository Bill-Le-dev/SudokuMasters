...
import SudokuPuzzleMaster.constants.GameState;
import SudokuPuzzleMaster.problemdomain.Coordinates;
...
import static SudokuPuzzleMaster.Main.deleteGameData;
import static SudokuPuzzleMaster.Main.getElapsedTimeSecs;
...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
    ...
    private static final Color WINDOW_BACKGROUND_COLOR = Color.BEIGE;
    private static final Color BOARD_BACKGROUND_COLOR = Color.IVORY;
    ...
    private void drawTitle(Group root) {
        Text title = new Text(190, 715, SUDOKU);
        title.setFill(Color.SADDLEBROWN);
        Font titleFont = new Font(90);
    ...
    @Override
    public void showDialog(String message) throws IOException {
        Alert alert = new Alert(Alert.AlertType.INFORMATION, String.valueOf("Score in secs: "+getElapsedTimeSecs()));
        alert.showAndWait();
